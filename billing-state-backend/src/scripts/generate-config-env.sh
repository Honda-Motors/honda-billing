...
# Set MongoDB URLs
echo "MONGO_URL=mongodb://mongodb:27017/honda" >> ./src/config/config.env
echo "MONGO_DEV_URL=mongodb://mongodb:27017/honda" >> ./src/config/config.env
...
# Give read and write permissions to config.env
chmod +rw ./src/config/config.env
